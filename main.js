...
<header>
    ...
    <br>
    <span class="button">Fase de grupos</span>
    <span class="button">Fase de grupos</span>
    <span class="button">Fase de grupos</span>
    <span class="button">Fase de grupos</span>
</header>
<main id="cards">
  ...
  ${createCard(
    ...
    createGame("suíça", "07:00", "camarões", estadio(3) /*group g*/) +
      createGame("uruguai", "10:00", "coreia do sul", estadio(7) /*group h*/) +
  ...
  ${createCard(
    ...
    createGame("gales", "07:00", "irã", estadio(5) /*group b*/) +
      createGame("catar", "10:00", "senegal", estadio(2) /*group a*/) +
      createGame("holanda", "13:00", "equador", estadio(1) /*group a*/) +
      createGame(
        "inglaterra",
        "16:00",
        "estados unidos",
  ...
  ${createCard(
    "26/11",
    "sábado",
    createGame("tunísia", "07:00", "austrália", estadio(3) /*group d*/) +
      createGame("polônia", "10:00", "arábia saudita", estadio(7) /*group c*/) +
  ...
  ${createCard(
    "27/11",
    "domingo",
    createGame("japão", "07:00", "costa rica", estadio(5) /*group e*/) +
      createGame("bélgica", "10:00", "marrocos", estadio(2) /*group f*/) +
      createGame("croácia", "13:00", "canadá", estadio(1) /*group f*/) +
  ...
  ${createCard(
    ...
    createGame("camarões", "07:00", "sérvia", estadio(3) /*group g*/) +
      createGame("coreia do sul", "10:00", "gana", estadio(7) /*group h*/) +
  ...
  ${createCard(
    "02/12",
    "sexta",
    createGame("coreia do sul", "07:00", "portugal", estadio(7) /*group h*/) +
